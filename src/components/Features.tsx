...
const features = [
  { icon: Box, title: "3D Virtual Gallery", text: "Explore our collection from anywhere with immersive 3D walkthroughs." },
  { icon: Brush, title: "Custom Art Orders", text: "Commission bespoke pieces tailored to your vision and space." },
  ...
  { icon: Bell, title: "Instant Notifications", text: "Stay informed about new arrivals, order status, and exclusive events." },
          ...
          {features.map((feat, i) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-card border border-border rounded-3xl p-8 hover:-translate-y-1 hover:border-accent/30 hover:shadow-organic transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-full bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 group-hover:scale-110 transition-all duration-300">
