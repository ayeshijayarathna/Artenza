...
export default function About() {
  return (
    <section id="about" className="py-24 px-4 bg-charcoal/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {highlights.map((item) => {
            ...
            return (
              <div key={item.title}
                className="bg-obsidian/60 border border-warm-gray/20 rounded-lg p-8 text-center hover:border-gold/30 transition-colors group">
                <Icon className="w-10 h-10 text-gold/80 mx-auto mb-5 group-hover:text-gold transition-colors" />
                <h3 className="font-serif text-xl font-semibold text-linen mb-3">{item.title}</h3>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-linen/80 text-lg leading-relaxed font-serif italic">
